...
export default function Home() {
  ...
  const quickLinks = [
    ...
    { img: facebookLogo, title: 'Facebook', link: 'https://www.snapchat.com/add/aditi6707/' },
  ]
      ...
      <div className="home-top">
        ...
        >
          ...
          <motion.div className="info-cards">
            {[
              { label: '📍 Location', value: 'New Delhi, Delhi, India' },
              { label: '💼 Expertise', value: 'Data Analyst, Electrical Engineer' },
              { label: '📧 Contact', value: 'aditikarnoff88@gmail.com' },
            ].map((info, i) => (
